...
public class Constance {
    ...
    public static String[] APLIAYTYPE= new String[]{"支付宝支付", "微信支付"};
    ...
    // appid
    public static final String APP_ID = "wxe30c8b4b99cc2c48";// yum

    // 商户号
    public static final String MCH_ID = "1432581902";// yum

    // API密钥，在商户平台设置
    public static final String API_KEY = "67856b654d3fde70bf56855469413671";// yum
