...
//            startActivity(logoutIntent);
            View popupView = getActivity().getLayoutInflater().inflate(R.layout.popuplayout, null);
            OutLoginPopWindow popWindow=new OutLoginPopWindow(getActivity());
            popWindow.mActivity=getActivity();
            if(getActivity()!=null&&!getActivity().isFinishing())popWindow.onShow(popupView);
            return true;
        }
        return  false;
    }
