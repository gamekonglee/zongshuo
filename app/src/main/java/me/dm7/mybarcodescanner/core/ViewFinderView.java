package me.dm7.mybarcodescanner.core;
...
public class ViewFinderView extends View implements IViewFinder {
    ...
    private final int mDefaultLaserColor = getResources().getColor(R.color.green);
    private final int mDefaultMaskColor = getResources().getColor(R.color.green);
    private final int mDefaultBorderColor = getResources().getColor(R.color.white);
    private final int mDefaultBorderStrokeWidth = 2;
