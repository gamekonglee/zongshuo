...
public abstract class BarcodeScannerView extends FrameLayout implements Camera.PreviewCallback  {
    ...
    public BarcodeScannerView(Context context, AttributeSet attributeSet) {
        ...
        try {
            ...
            mBorderWidth = a.getDimensionPixelSize(R.styleable.BarcodeScannerView_borderWidth, 4);
            mBorderLength = a.getDimensionPixelSize(R.styleable.BarcodeScannerView_borderLength, 60);
